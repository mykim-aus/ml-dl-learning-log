...
Just follow my curiosity down the rabbit hole, then loop forever:

1. Chase whatever I'm curious about — let one question lead to the next.
2. Implement what I asked about in code.
3. Explain it back in my own words.
4. Repeat, endlessly.
...
그냥 궁금한 걸 꼬리물기로 파고들며 무한 반복:

1. 궁금한 걸 꼬리물기로 계속 질문한다.
2. 물어본 걸 코드로 직접 구현해본다.
3. 내 말로 설명해본다.
4. 무한 반복.
